...
const PricingCardOne = () => {
    return (
        <div className="max-w-xs border-2 border-gray-200 rounded-xl p-4 flex flex-col items-center shadow-2xl lg:max-w-sm md:max-w-xs flex-grow m-5">
            <h3 className="mb-4 text-3xl font-semibold text-center text-slate-800">Starter</h3>
            <p className="font-normal text-gray-500 sm:text-lg dark:text-gray-500 text-center">Best option for personal use & for your next project.</p>
